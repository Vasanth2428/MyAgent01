...
class RAGContextEngine:
    ...
    def __init__(self, retriever: WeaviateRetriever, pipeline_config: Optional[PipelineConfig] = None, checkpointer: Optional[any] = None):
        ...
        self.generation_service = GenerationService(model=LLM_MODEL, temperature=LLM_TEMPERATURE)
    ...
    async def _ask_async_internal(self, query: str, session_id: str = "default", mode: str = "context_engine",
        ...
        if mode == "agentic":
            ...
            initial_state = create_initial_state(messages, bypass_hitl=bypass_hitl)
